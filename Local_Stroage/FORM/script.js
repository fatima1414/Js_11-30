...
signup.addEventListener("submit", (e) => {
  ...
  if (
    StringRegEx.test(username) && email && MobileRegEx.test(mobile) && password && city && gender && hobby.length 
    > 0 &&  address ) {
    ...
    const user = {
      id,
      username: username,
      email, mobile, city, gender: gender.value, hobby: arr, address,  
     };
